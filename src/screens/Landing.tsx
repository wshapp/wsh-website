...
const BackgroundHeader = styled.div`
    ...
    width: 100%;
    height: 100vh;
    background: linear-gradient(180deg, rgba(0, 0, 0, 0.2) 0%, rgba(0, 0, 0, 0.304958) 0.01%, rgba(0, 0, 0, 0.975) 99.99%, ${props => props.theme.colors.background.primary} 100%), url('/static/images/landing-background.jpg');
